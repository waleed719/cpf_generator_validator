...
  // Componente de Navegação (corrigido e completo)
  const Navigation = () => {
    const navItems = [
...
    );
  
    // JSX de Retorno da Navegação (movido para o local correto)
    return (
...
      </nav>
    );
  }; // Fim da função Navigation

  // Componentes de Páginas e Auxiliares (movidos para o escopo principal do CPFValidatorGenerator)
...
  const HomePage = () => ( 
    <div>
      <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
      {/* CPF VALIDATOR SECTION - NOW ON HOMEPAGE */}
...
                {language === 'pt' ? 'Precisa gerar CPFs para testes?' : 'Need to generate CPFs for testing?'}
              </p>
              <a
                href="/gerador-cpf"
...
      {/* STATS SECTION */}
      <section className="py-8 sm:py-12 bg-gradient-to-br from-gray-50 to-blue-50 border-y">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
            ].map((feature, idx) => (
              <div key={idx} className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-6 sm:p-8 hover:shadow-xl transition border border-gray-100">
...
            {language === 'pt'
              ? 'Use nossas ferramentas gratuitamente agora mesmo!'
              : 'Use our tools for free right now!'}
          </p>
...
            <a
              href="/lote-cpf"
              onClick={(e) => { e.preventDefault(); navigate('/lote-cpf'); }}
